...
public class TelaGerente {
    ...
    public void montarTelaGerente(final BD bd, final Estoque estoque, Caixa caixa, final JFrame telaLogin) {
        final JFrame frame = new JFrame("Supermercado MDS Caixa " + caixa.getIdCaixa());
        JPanel painelPrincipal = new JPanel(new BorderLayout());
        JButton inserirProduto = new JButton("Inserir produto no estoque");
        JButton relatorioVenda = new JButton("Relatório de Venda");
        JButton relatorioEstoque = new JButton("Relatório de Estoque");
        ...
        relatorioVenda.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JOptionPane.showMessageDialog(null, "Relatirio gerado");
            }            
        });
